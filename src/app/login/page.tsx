    ...
    async function onSubmit( values :  LoginForm ) {
        ...
        if(!newUserStates){
            ...
            try{
                ...
                resetForm();
                notify.notify("Usuário saved com sucesso!", "success");
            ...
            <div  className ="mt- sm:mx-auto sm:w-full sm:max-w-sm">
                <form  onSubmit ={handleSubmit}  className ="space-y-2">
                    ...
                    <div>
                        < RendeIf   condition ={newUserStates}>
                            < Button   type ="submit"
                                style ="bg-[#C05C32] hover:bg-[#A84A24] text-white mt-3 w-full"
                                label ="Salvar"/>
                            <span
                                onClick ={() => setNewUserStates(false)}
                                className ="block text-sm text-[#C05C32] hover:underline mt-4 cursor-pointer"
                            >
